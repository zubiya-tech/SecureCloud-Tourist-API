...
Before this I mostly worked with frontend stuff and small scripts. I wanted to understand what's actually happening behind the screen how a database connects to an API, how something runs on a real server instead of localhost, how you add security to a thing people can hit from the internet.
